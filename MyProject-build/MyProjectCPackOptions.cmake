...
if(CPACK_GENERATOR MATCHES "NSIS")
  ...
  set(CPACK_PACKAGE_ICON "E:/B/MITK\\mitk.bmp")
  # set the install/unistall icon used for the installer itself
  # There is a bug in NSIS that does not handle full unix paths properly. 
  set(CPACK_NSIS_MUI_ICON "E:/B/MITK\\mitk.ico")
  set(CPACK_NSIS_MUI_UNIICON "E:/B/MITK\\mitk.ico")
  ...
  set(CPACK_PACKAGE_EXECUTABLES "MyApp;MITK - MyApp Application;MyApp;MITK - MyApp Application;MyApp;MITK - MyApp Application")
     
  # tell cpack to create a desktop link to MainApp
  set(CPACK_CREATE_DESKTOP_LINKS "MyApp;MyApp")
