...
set(MITK_CMAKE_MODULE_PATH "E:/B/MITK/CMake")
...
set(MITK_SOURCE_DIR "E:/B/MITK")
set(MITK_BINARY_DIR "E:/B/MITK-superbuild/MITK-build")
set(MITK_CMAKE_DIR "E:/B/MITK/CMake")

# MITK output directories
set(MITK_CMAKE_RUNTIME_OUTPUT_DIRECTORY "E:/B/MITK-superbuild/MITK-build/bin")
set(MITK_CMAKE_ARCHIVE_OUTPUT_DIRECTORY "E:/B/MITK-superbuild/MITK-build/lib")
set(MITK_CMAKE_LIBRARY_OUTPUT_DIRECTORY "E:/B/MITK-superbuild/MITK-build/lib")
...
set(MITK_DATA_DIR "")
set(UTILITIES_DIR "E:/B/MITK/Utilities")
...
if(CMAKE_CURRENT_LIST_DIR_REALPATH STREQUAL MITK_BINARY_DIR)
  set(MITK_EXTERNAL_PROJECT_PREFIX E:/B/MITK-superbuild/ep)
endif()

set(MITK_MODULES_PACKAGE_DEPENDS_DIR "E:/B/MITK/CMake/PackageDepends")
...
list(APPEND CMAKE_PREFIX_PATH "E:/B/MITK-superbuild/ep")
...
if(MITK_USE_Boost)
  set(BOOST_ROOT "E:/B/MITK-superbuild/ep" CACHE PATH "")
  set(BOOST_LIBRARYDIR "E:/B/MITK-superbuild/ep/lib" CACHE PATH "")
  set(Boost_ADDITIONAL_VERSIONS "1.59" "1.59.0")
endif()

# We need this later for a DCMTK workaround
set(_dcmtk_dir_orig "E:/B/MITK-superbuild/ep")
...
set(MITK_Poco_DIR "E:/B/MITK-superbuild/ep/lib/cmake/Poco")
set(MITK_Poco_COMPONENTS Foundation;Net;Util;XML;Zip)

set(MITK_USE_DCMTK ON)
set(MITK_DCMTK_DIR "E:/B/MITK-superbuild/ep")
...
set(MITK_tinyxml_DIR "E:/B/MITK-superbuild/ep/lib/cmake/tinyxml")
set(MITK_tinyxml_COMPONENTS )

set(MITK_USE_GDCM ON)
set(MITK_GDCM_DIR "E:/B/MITK-superbuild/ep/lib/gdcm-2.4")
...
set(MITK_GLEW_DIR "E:/B/MITK-superbuild/ep/lib/cmake/GLEW")
set(MITK_GLEW_COMPONENTS )

set(MITK_USE_ANN ON)
set(MITK_ANN_DIR "E:/B/MITK-superbuild/ep/lib/cmake/ANN")
set(MITK_ANN_COMPONENTS )

set(MITK_USE_CppUnit ON)
set(MITK_CppUnit_DIR "E:/B/MITK-superbuild/ep/lib/cmake/CppUnit")
...
set(MITK_ITK_DIR "E:/B/MITK-superbuild/ep/lib/cmake/ITK-4.7")
set(MITK_ITK_COMPONENTS )

set(MITK_USE_VTK TRUE)
set(MITK_VTK_DIR "E:/B/MITK-superbuild/ep/lib/cmake/vtk-6.2")
...
set(MITK_USE_CTK ON)
set(MITK_CTK_DIR "E:/B/MITK-superbuild/ep/src/CTK-build")
...
set(MITK_USE_Qwt ON)
set(MITK_Qwt_DIR "E:/B/MITK-superbuild/ep/lib/cmake/Qwt")
...
set(CppMicroServices_DIR "E:/B/MITK-superbuild/MITK-build/Modules/CppMicroServices")
mitkMacroFindDependency(CppMicroServices)

set(MITK_USE_BLUEBERRY ON)
if(MITK_USE_BLUEBERRY)

  set(MITK_PLUGIN_USE_FILE "E:/B/MITK-superbuild/MITK-build/MitkPluginUseFile.cmake")
  ...
  set(MITK_PLUGIN_PROVISIONING_FILE "E:/B/MITK-superbuild/MITK-build/bin/MitkWorkbench.provisioning")
...
if(NOT MITK_EXPORTS_FILE_INCLUDED)
  if(EXISTS "E:/B/MITK-superbuild/MITK-build/MitkExports.cmake")
    set(MITK_EXPORTS_FILE_INCLUDED 1)
    include("E:/B/MITK-superbuild/MITK-build/MitkExports.cmake")
  endif()
endif()
...
if(EXISTS "E:/B/MITK-superbuild/MITK-build/mitkToFHardwareInstallRules.cmake")
  include("E:/B/MITK-superbuild/MITK-build/mitkToFHardwareInstallRules.cmake")
endif()
